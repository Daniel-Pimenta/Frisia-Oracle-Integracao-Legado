create or replace package XXFR_OM_PKG_DEVOLUCAO_SACARIA is
  procedure main(
    p_trip_id                 in number,
    p_sacaria_item            in number, 
    p_sacaria_qtd             in number, 
    p_sacaria_cliente_remessa in number, 
    p_sacaria_endereco        in number
  );
end;
/ 
...
-- +==========================================================================+
  ...
  begin
    ...
    begin
      select distinct organization_id, oe_header, p_sacaria_item, p_sacaria_qtd, p_sacaria_cliente_remessa, p_sacaria_endereco 
