...
-- +==========================================================================+
  ...
  g_versao                    varchar2(100) := '2020.04.29.017';
  ...
  procedure print_out(msg   in Varchar2) is
    ...
    l_msg    varchar2(3000);
  begin
    --select (sysdate - g_time) into l_diff from dual;
    --l_msg := to_char(l_diff, 'MI:SSxFF') ||' - '||msg;
          ...
          for i in 1 .. a_portaria.count loop
            ...
            if (ok) then
              ...
              if (a_portaria(i).entrega.percurso.dist.count = 0) then
                ...
                if (ok and a_portaria(1).entrega.ie_conteudo_firme='SIM') then             
  ...
  begin
    ...
    if (g_ie_manter_percurso is null) then
      ...
      if (ok) then --and g_ie_manter_percurso = 'SIM') then 
        ...
        for r1 in c2 loop
          n := n + 1;
          if (n = 1) then print_out('Processo MoveOrder Backorder');  end if;
  ...
  begin
    print_out('');
    print_out('XXFR_WSH_PCK_INT_ENTREGA.CRIAR_ATUALIZAR_ENTREGA('||p_action_code||')');
    ok :=true;
    --
    ...
    if (p_dist.cd_cliente is not null) then
      ...
      begin
        ...
        where 1=1
          ...
          --
          --and ov.numero_ordem           = '4' 
          --and ov.tipo_ordem             = '191_VENDA' 
          --and ov.linha                  = '1' 
          --
    ...
    if (ok and p_action_code = 'CREATE') then
      ...
      --
      l_delivery_rec_typ.gross_weight                  := l_gross_weight;
