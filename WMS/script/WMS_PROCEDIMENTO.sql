...
begin
  ...
  --
  if (op = 1) then
    XXFR_WMS_PCK_INT_SEPARACAO.processar_separacao(
...
WHERE 1=1
  and id_integracao_detalhe = 1780
...
where 1=1
  ...
  AND UPPER(DS_ESCOPO) like 'PROCESSAR_ORDEM_SEPARACAO_SEMENTE%'
order by id;
