create or replace PACKAGE BODY iby_fd_extract_ext_pub AS
  ...
  */
  ...
  BEGIN
    ...
    BEGIN
      ...
      IF (jg_zz_shared_pkg.get_country(l_org_id, NULL, NULL) = 'BR') THEN
        ...
        SELECT xmlconcat(cll_f033_iby_extract_ext_pub.get_ins_ext_agg(p_payment_instruction_id),
  ...
  BEGIN
    ...
    BEGIN
      ...
      IF (jg_zz_shared_pkg.get_country(l_org_id, NULL, NULL) = 'BR') THEN
        ...
        SELECT xmlconcat(cll_f033_iby_extract_ext_pub.get_pmt_ext_agg(p_payment_id),
  ...
  BEGIN
    ...
    BEGIN
      ...
      IF (jg_zz_shared_pkg.get_country(l_org_id, NULL, NULL) = 'BR') THEN
        ...
        SELECT xmlconcat(cll_f033_iby_extract_ext_pub.get_doc_ext_agg(p_document_payable_id),
  ...
  FUNCTION get_docline_ext_agg(p_document_payable_id IN NUMBER
                              ,p_line_number         IN NUMBER) RETURN xmltype IS
  BEGIN
    RETURN NULL;
